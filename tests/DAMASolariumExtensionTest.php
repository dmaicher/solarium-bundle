...
use DAMA\SolariumBundle\DependencyInjection\DAMASolariumExtension;
...
class DAMASolariumExtensionTest extends TestCase
{
    ...
    public function testClientRegistry(): void
    {
        ...
        $this->assertInstanceOf(Psr11ClientRegistry::class, $clientRegistry);
    ...
    public function testDataCollector(): void
    {
        ...
        $this->assertInstanceOf(DataCollector::class, $container->get('solarium.data_collector'));
        ...
        $this->assertInstanceOf(DataCollector::class, $preExecuteListeners[0][0]);
        ...
        $this->assertInstanceOf(DataCollector::class, $postExecuteListeners[0][0]);
    ...
    private function createCompiledContainerForConfig($config, $debug = false, $extraServices = [])
    {
        ...
        $container->registerExtension(new DAMASolariumExtension());
        $container->loadFromExtension('framework', []);
        $container->loadFromExtension('dama_solarium', $config);
